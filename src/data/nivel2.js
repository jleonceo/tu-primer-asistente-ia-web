// Nivel 2 · Un enjambre de skills. Coordinador + verificador, el flujo de un
// documento a un asiento y los seis enjambres del proyecto. 24/09/2026: el nivel
// pasa a llamarse «un enjambre de skills» en lugar de «un equipo».
// 24/09/2026: reescrito con el registro de la guía de estilo del proyecto. El flujo contable
...
export const nivel2 = {
  meta: {
    ...
    description: 'Cuando una skill no basta: varias skills que trabajan juntas, con un coordinador que reparte el trabajo y un verificador que lo revisa. Con los seis enjambres de este proyecto como ejemplo.',
  },
  n: '2',
  ...
  bloques: [
    {
      ...
      parrafos: [
        ...
        'En un enjambre, cada skill tiene unas instrucciones cortas para un solo paso y le entrega su resultado a la siguiente. Cuando lo que está en juego importa, hacen falta además dos papeles.',
      ],
    },
    {
      tipo: 'piezas',
      titulo: 'Los dos papeles que necesita un enjambre',
      items: [
        {
    ...
    },
    {
      ...
      intro: 'Este es el recorrido del enjambre de contabilidad. Cada paso lo hace una skill distinta, que le entrega su resultado a la siguiente:',
      pasos: [
      ...
      cierre: 'El enjambre <b>propone</b> y una persona aprueba antes de cualquier cambio definitivo. Lo que no se puede deshacer lo decide siempre una persona.',
    },
    {
      tipo: 'destacado',
    ...
    {
      tipo: 'equipos',
      titulo: 'Seis enjambres montados sobre la misma empresa simulada',
      intro: 'El mismo método se ha aplicado a seis dominios distintos, todos sobre la contabilidad y los datos de una empresa simulada. Cada enjambre se ocupa de un área:',
      items: [
  ...
  cta: {
    ...
    sub: 'Cada skill del enjambre se escribe y se prueba igual que la primera. Por eso se empieza por una sola.',
