...
// 24/09/2026: reescrito con el registro de la guía del M6. Skill y CLAUDE.md
...
export const glosario = {
  ...
  mas: {
    ...
    sub: 'Aparecen al hablar de equipos de skills. No hacen falta para empezar.',
    items: [
      ...
      { palabra: 'Orquestador', def: 'La skill que recibe un encargo y lo envía al especialista que corresponde. Reparte el trabajo sin hacerlo.', analogia: 'Hace lo mismo que la centralita de una clínica, que pasa cada llamada a la consulta que corresponde.' },
      { palabra: 'Enjambre', def: 'Un grupo de skills encadenadas que resuelven juntas una tarea con varios pasos distintos.', analogia: 'Funciona como una cadena de montaje: cada puesto hace su parte y al final sale el producto terminado.' },
  ...
  cierre: {
    ...
    texto: ' El asistente completo y los equipos se construyen después, encima de ella. Para empezar no hace falta entender todo lo anterior.',
  },
